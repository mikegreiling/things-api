 ...
 * as the probe gated it (`xcode-select -p`). When the gate says no — or the
 * sidecar cannot be spawned, or its handshake fails — every script is generated
 * BYTE-IDENTICALLY to the polling version that shipped before this campaign and
 * the drive proceeds on it. Availability failure is a fallback, never a
