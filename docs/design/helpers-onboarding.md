...
| 2 | automation → Things | `hello.automation.things === "granted"` | `tell application "Things3" to version` through the deputy's `osascript` verb, 120s | `granted` · `denied` (-1743) · `pending` (unanswered) |
