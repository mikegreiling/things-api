...
**Probed under: `things-lab-golden-v4` · Things 3.23 (32300036) · macOS 15.7.7 · guest clock pinned 2026-07-05 (trial wall 2026-07-18, never rolled) · AXVM1 direct grant, no helpers.** Disposable clones (`gscr-chord4-*`), destroyed on teardown. All fixtures synthetic, seeded through the shipped CLI's URL-scheme vector — never a direct SQLite write. Driver: [`lab/scripts/research-chord4.sh`](../../lab/scripts/research-chord4.sh).
