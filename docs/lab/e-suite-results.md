...
Suite: [lab/suites/e-suite.json](../../lab/suites/e-suite.json) (10 probes, E01–E10). Locked 2026-07-04 after discovery (one adjustment: E08 → unsupported) + acceptance ×2 identical. All tier 0, app running in background, no crashes. Closes the "cheap editing gaps" batch (tracked in [docs/capability-matrix.md](../capability-matrix.md)).
