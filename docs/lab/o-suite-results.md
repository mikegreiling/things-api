...
Areas among areas (every spelling dead — P9c exhausts the sdef-informed candidates); the Anytime list-scope convention for loose to-dos (P7b/P8d inconsistent); checklist-item order (no granular surface anywhere).
